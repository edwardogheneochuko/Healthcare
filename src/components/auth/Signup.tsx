  ...
  return (
    <div className='text-white'>
      ...
      { isOpen ? 
        ...
        className='text-center text-gray-600 cursor-pointer'>Back</p>
        </form>
       :
   ...
   <span className='flex-1 h-px bg-gray-300'></span>
      ...
      className='w-full bg-black hover:bg-neutral-900 duration-200  border rounded-4xl text-lg
         border-gray-800 py-3 px-4 shadow-sm flex items-center justify-center gap-3 transition disabled:opacity-60
